        ...
        <template #content>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div class="mt-4 p-2 inline-block bg-white dark:bg-gray-100" v-html="qrCode" />
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg">
